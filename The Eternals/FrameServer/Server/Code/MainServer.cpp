...
void Initialize_NPC()
{
	...
	//{
	//	/* NPC의 정보 초기화 */
	//	pNew->Ready_NPC(_vec3(122.0f, 0.f, 76.0f), _vec3(0.f, 0.f, 0.f), NPC_NONMOVE, NPC_VILLAGERS, STAGE_VELIKA);
	...
	//{
	//	/* NPC의 정보 초기화 */
	//	pNew->Ready_NPC(_vec3(127.0f, 0.f, 76.0f), _vec3(0.f, 0.f, 0.f), NPC_NONMOVE, NPC_BARAKA_EXTRACTOR, STAGE_VELIKA);

...
void CObjMgr::Create_StageWinterMonster()
{
	...
	if (pNew)
	{
		...
		//pNew->Ready_Monster(_vec3(380.0f, 0.f, 390.0f), _vec3(0.f, -180.0f, 0.f), MON_NORMAL, MON_VERGOS, STAGE_WINTER, 20000, GIANTMONKEY_ATT, GIANTMONKEY_EXP, GIANTMONKEY_SPD);

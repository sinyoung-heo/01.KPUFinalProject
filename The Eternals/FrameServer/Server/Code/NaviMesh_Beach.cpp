...
IMPLEMENT_SINGLETON(CNaviMesh_Beach)

CNaviMesh_Beach::CNaviMesh_Beach()
	: m_dwCurrentIdx(0)
{

}

_vec3 CNaviMesh_Beach::Get_CellCenterPos(const _ulong& dwIndex)
{
...
int CNaviMesh_Beach::Get_CurrentPositionCellIndex(const _vec3& vPos)
{
...
_vec3 CNaviMesh_Beach::Move_OnNaviMesh(const _vec3* pTargetPos, const _vec3* pTargetDir, const float& fSpeed, const bool& bIsJump)
{
...
HRESULT CNaviMesh_Beach::Ready_NaviMesh(wstring wstrFilePath)
{
...
void CNaviMesh_Beach::Link_Cell()
{

...
namespace Gladiator
{
	...
	constexpr int NUM_ANIMATION = 30;
	static double duration[NUM_ANIMATION] =
	{
		14240,4800,3680,4480,3360,4160,4800,3840,5760,4640,
		4320,4000,9600,11520,11520,7680,14400,3200,2880,3200,
		4000,9600,3200,8160,5120,8480,3840,6560,8640,9600
	};
	...
	constexpr float OTHERS_OFFSET	= 0.8f;

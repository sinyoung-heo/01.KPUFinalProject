...
class CHuman_boy : public Engine::CGameObject
{
private:
	explicit CHuman_boy(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	explicit CHuman_boy(const CHuman_boy& rhs);
	virtual ~CHuman_boy() = default;

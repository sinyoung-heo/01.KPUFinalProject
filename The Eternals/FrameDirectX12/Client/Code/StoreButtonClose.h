...
class CStoreButtonClose : public CGameUIChild
{
private:
	explicit CStoreButtonClose(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CStoreButtonClose() = default;

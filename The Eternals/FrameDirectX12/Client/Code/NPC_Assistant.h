...
class CNPC_Assistant : public Engine::CGameObject
{
private:
	explicit CNPC_Assistant(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CNPC_Assistant() = default;

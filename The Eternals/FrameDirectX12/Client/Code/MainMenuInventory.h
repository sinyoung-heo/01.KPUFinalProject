...
class CMainMenuInventory : public CGameUIRoot
{
private:
	explicit CMainMenuInventory(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CMainMenuInventory() = default;

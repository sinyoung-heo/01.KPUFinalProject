...
HRESULT CCinemaVergos::Ready_GameObject(wstring wstrMeshTag, wstring wstrNaviMeshTag, const _vec3& vScale, const _vec3& vAngle, const _vec3& vPos)
{
	...
	m_uiAnimIdx = 0;
	m_iMonsterStatus = CinemaVergos::A_WAIT;

	return S_OK;
}

HRESULT CCinemaVergos::LateInit_GameObject()
{
...
_int CCinemaVergos::Update_GameObject(const _float& fTimeDelta)
{
...
_int CCinemaVergos::LateUpdate_GameObject(const _float& fTimeDelta)
{
...
void CCinemaVergos::Send_PacketToServer()
{
}

void CCinemaVergos::Render_MiniMap(const _float& fTimeDelta)
{
...
void CCinemaVergos::Render_GameObject(const _float& fTimeDelta, ID3D12GraphicsCommandList* pCommandList, const _int& iContextIdx)
{
	Render_HitEffect(fTimeDelta);
	m_pMeshCom->Render_DynamicMesh(pCommandList, iContextIdx, m_pShaderCom);
}

void CCinemaVergos::Render_ShadowDepth(const _float& fTimeDelta, ID3D12GraphicsCommandList* pCommandList, const _int& iContextIdx)
{
	if (!m_bIsStartDissolve)
	{
...
HRESULT CCinemaVergos::Add_Component(wstring wstrMeshTag, wstring wstrNaviMeshTag)
{
...
void CCinemaVergos::Set_ConstantTable()
{
	/*__________________________________________________________________________________________________________
...
void CCinemaVergos::Set_ConstantTableShadowDepth()
{
	/*__________________________________________________________________________________________________________
	[ Set ConstantBuffer Data ]
	____________________________________________________________________________________________________________*/
...
void CCinemaVergos::Set_ConstantTableMiniMap()
{
...
void CCinemaVergos::SetUp_AngleInterpolation(const _float& fTimeDelta)
{
...
void CCinemaVergos::SetUp_Dissolve(const _float& fTimeDelta)
{
	if (m_bIsStartDissolve)
	{
...
void CCinemaVergos::Active_Monster(const _float& fTimeDelta)
{
...
void CCinemaVergos::Change_Animation(const _float& fTimeDelta)
{
	if (m_pMeshCom->Is_BlendingComplete())
	{
...
void CCinemaVergos::SetUp_CollisionTick(const _float& fTimeDelta)
{
...
Engine::CGameObject* CCinemaVergos::Create(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList, wstring wstrMeshTag, wstring wstrNaviMeshTag, const _vec3& vScale, const _vec3& vAngle, const _vec3& vPos)
{
	CCinemaVergos* pInstance = new CCinemaVergos(pGraphicDevice, pCommandList);
...
CCinemaVergos** CCinemaVergos::Create_InstancePool(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList, const _uint& uiInstanceCnt)
{
	CCinemaVergos** ppInstance = new (CCinemaVergos * [uiInstanceCnt]);

	for (_uint i = 0; i < uiInstanceCnt; ++i)
	{
		ppInstance[i] = new CCinemaVergos(pGraphicDevice, pCommandList);
		ppInstance[i]->m_uiInstanceIdx = i;
		ppInstance[i]->Ready_GameObject(L"CinemaVergos",					// MeshTag

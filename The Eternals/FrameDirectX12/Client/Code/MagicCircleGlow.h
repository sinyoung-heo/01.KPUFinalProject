...
class CMagicCircleGlow : public Engine::CGameObject
{
private:
	explicit CMagicCircleGlow(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CMagicCircleGlow() = default; 

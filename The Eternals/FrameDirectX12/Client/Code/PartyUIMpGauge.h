...
class CPartyUIMpGauge : public CGameUIChild
{
private:
	explicit CPartyUIMpGauge(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CPartyUIMpGauge() = default;

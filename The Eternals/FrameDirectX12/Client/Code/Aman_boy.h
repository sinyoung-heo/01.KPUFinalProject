...
class CAman_boy : public Engine::CGameObject
{
private:
	explicit CAman_boy(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	explicit CAman_boy(const CAman_boy& rhs);
	virtual ~CAman_boy() = default;

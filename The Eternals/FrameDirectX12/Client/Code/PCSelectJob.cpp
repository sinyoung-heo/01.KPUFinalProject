...
CPCSelectJob::CPCSelectJob(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: CGameUIChild(pGraphicDevice, pCommandList)
{
}

HRESULT CPCSelectJob::Ready_GameObject(wstring wstrRootObjectTag, 
...
HRESULT CPCSelectJob::LateInit_GameObject()
{
...
_int CPCSelectJob::Update_GameObject(const _float& fTimeDelta)
{
...
_int CPCSelectJob::LateUpdate_GameObject(const _float& fTimeDelta)
{
	if (g_bIsLoadingFinish)
...
void CPCSelectJob::Render_GameObject(const _float& fTimeDelta)
{
...
void CPCSelectJob::Set_ConstantTable()
{
...
Engine::CGameObject* CPCSelectJob::Create(ID3D12Device* pGraphicDevice, 
										  ...
										  const _long& iUIDepth)
{
	CPCSelectJob* pInstance = new CPCSelectJob(pGraphicDevice, pCommandList);

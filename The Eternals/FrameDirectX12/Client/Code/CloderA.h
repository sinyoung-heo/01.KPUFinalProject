...
class CCloderA : public Engine::CGameObject
{
private:
	explicit CCloderA(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CCloderA() = default;
...
public:
	...
	static CCloderA** Create_InstancePool(ID3D12Device* pGraphicDevice,
										  ID3D12GraphicsCommandList* pCommandList, 

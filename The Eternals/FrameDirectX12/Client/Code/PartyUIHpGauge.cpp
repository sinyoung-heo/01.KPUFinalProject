...
CPartyUIHpGauge::CPartyUIHpGauge(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: CGameUIChild(pGraphicDevice, pCommandList)
{
}

HRESULT CPartyUIHpGauge::Ready_GameObject(wstring wstrRootObjectTag, 
...
HRESULT CPartyUIHpGauge::LateInit_GameObject()
{
...
_int CPartyUIHpGauge::Update_GameObject(const _float& fTimeDelta)
{
...
_int CPartyUIHpGauge::LateUpdate_GameObject(const _float& fTimeDelta)
{
	if (!m_bIsActive)
		return NO_EVENT;
...
void CPartyUIHpGauge::Render_GameObject(const _float& fTimeDelta)
{
...
void CPartyUIHpGauge::Set_ConstantTable()
{
...
Engine::CGameObject* CPartyUIHpGauge::Create(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList,
											 ...
											 const _long& iUIDepth)
{
	CPartyUIHpGauge* pInstance = new CPartyUIHpGauge(pGraphicDevice, pCommandList);

...
class CPartyUIHpGauge : public CGameUIChild
{
private:
	explicit CPartyUIHpGauge(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CPartyUIHpGauge() = default;

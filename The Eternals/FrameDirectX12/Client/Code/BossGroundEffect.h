...
class CBossGroundEffect : public Engine::CGameObject
{
private:
	explicit CBossGroundEffect(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CBossGroundEffect() = default; 
...
public:
	...
	static CBossGroundEffect** Create_InstancePool(ID3D12Device* pGraphicDevice,
		ID3D12GraphicsCommandList* pCommandList,

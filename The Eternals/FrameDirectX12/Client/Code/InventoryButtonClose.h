...
class CInventoryButtonClose : public CGameUIChild
{
private:
	explicit CInventoryButtonClose(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CInventoryButtonClose() = default;

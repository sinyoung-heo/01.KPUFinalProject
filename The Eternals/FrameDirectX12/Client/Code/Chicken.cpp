...
CChicken::CChicken(ID3D12Device * pGraphicDevice, ID3D12GraphicsCommandList * pCommandList)
...
HRESULT CChicken::Ready_GameObject(wstring wstrMeshTag,
...
HRESULT CChicken::LateInit_GameObject()
{
	/*__________________________________________________________________________________________________________
...
_int CChicken::Update_GameObject(const _float & fTimeDelta)
{
...
_int CChicken::LateUpdate_GameObject(const _float & fTimeDelta)
{
...
void CChicken::Render_GameObject(const _float & fTimeDelta)
{
	/*__________________________________________________________________________________________________________
	[ Play Animation ]
	____________________________________________________________________________________________________________*/
...
void CChicken::Render_ShadowDepth(const _float & fTimeDelta)
{
...
void CChicken::Render_ShadowDepth(const _float& fTimeDelta, ID3D12GraphicsCommandList * pCommandList, const _int& iContextIdx)
{
	Set_ConstantTableShadowDepth();
	m_pMeshCom->Render_DynamicMeshShadowDepth(pCommandList, iContextIdx, m_pShadowCom);
}

HRESULT CChicken::Add_Component(wstring wstrMeshTag, wstring wstrNaviMeshTag)
{
...
void CChicken::Set_ConstantTable()
{
	/*__________________________________________________________________________________________________________
...
void CChicken::Set_ConstantTableShadowDepth()
{
	/*__________________________________________________________________________________________________________
	[ Set ConstantBuffer Data ]
	____________________________________________________________________________________________________________*/
...
Engine::CGameObject* CChicken::Create(ID3D12Device * pGraphicDevice, ID3D12GraphicsCommandList * pCommandList,
									   ...
									   const _vec3 & vPos)
{
	CChicken* pInstance = new CChicken(pGraphicDevice, pCommandList);

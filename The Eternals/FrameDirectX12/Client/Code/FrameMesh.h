...
class CFrameMesh : public Engine::CGameObject
{
private:
	explicit CFrameMesh(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CFrameMesh() = default; 

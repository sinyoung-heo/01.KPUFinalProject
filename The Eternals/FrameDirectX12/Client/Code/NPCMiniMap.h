...
class CNPCMiniMap : public Engine::CGameObject
{
private:
	explicit CNPCMiniMap(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CNPCMiniMap() = default;
public:

...
class CTonadoEffect : public Engine::CGameObject
{
private:
	explicit CTonadoEffect(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CTonadoEffect() = default; 
...
public:
	...
	static CTonadoEffect** Create_InstancePool(ID3D12Device* pGraphicDevice,
		ID3D12GraphicsCommandList* pCommandList,

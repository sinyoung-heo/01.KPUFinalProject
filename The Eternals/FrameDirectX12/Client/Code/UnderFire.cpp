...
#include "TimeMgr.h"
CUnderFire::CUnderFire(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: Engine::CGameObject(pGraphicDevice, pCommandList)
{
}

HRESULT CUnderFire::Ready_GameObject(wstring wstrTextureTag,
	const _vec3& vScale,
	const _vec3& vAngle,
	const _vec3& vPos,
	const FRAME& tFrame)
...
HRESULT CUnderFire::LateInit_GameObject()
{
...
_int CUnderFire::Update_GameObject(const _float& fTimeDelta)
{
...
_int CUnderFire::LateUpdate_GameObject(const _float& fTimeDelta)
{
...
void CUnderFire::Render_GameObject(const _float& fTimeDelta)
{
	Set_ConstantTable();
...
HRESULT CUnderFire::Add_Component(wstring wstrTextureTag)
{
...
void CUnderFire::Set_ConstantTable()
{
	/*__________________________________________________________________________________________________________
...
void CUnderFire::Update_SpriteFrame(const _float& fTimeDelta)
{
...
Engine::CGameObject* CUnderFire::Create(ID3D12Device* pGraphicDevice,
	...
	const FRAME& tFrame)
{
	CUnderFire* pInstance = new CUnderFire(pGraphicDevice, pCommandList);

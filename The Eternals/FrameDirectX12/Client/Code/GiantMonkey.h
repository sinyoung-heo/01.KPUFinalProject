...
class CGiantMonkey : public Engine::CGameObject
{
private:
	explicit CGiantMonkey(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CGiantMonkey() = default;
...
private:
	...
	_bool	m_bIsEffectSoundStart		= false;
...
public:
	...
	static CGiantMonkey** Create_InstancePool(ID3D12Device* pGraphicDevice,
											  ID3D12GraphicsCommandList* pCommandList, 

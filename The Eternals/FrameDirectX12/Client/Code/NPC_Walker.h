...
class CNPC_Walker : public Engine::CGameObject
{
private:
	explicit CNPC_Walker(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CNPC_Walker() = default;

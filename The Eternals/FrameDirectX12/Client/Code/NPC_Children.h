...
class CNPC_Children : public Engine::CGameObject
{
private:
	explicit CNPC_Children(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
...
private:
	...
	void			Change_Animation_MoveType(const _float& fTimeDelta);
	void			Change_Animation_NonMoveType(const _float& fTimeDelta);
...
public:
	...
	static CNPC_Children** Create_InstancePool(ID3D12Device* pGraphicDevice,
											   ID3D12GraphicsCommandList* pCommandList, 
											   wstring wstrMeshTag,

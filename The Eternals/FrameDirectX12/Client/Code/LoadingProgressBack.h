...
class CLoadingProgressBack : public Engine::CGameObject
{
private:
	explicit CLoadingProgressBack(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CLoadingProgressBack() = default;

...
class CPrionBerserker : public Engine::CGameObject
{
private:
	explicit CPrionBerserker(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
...
public:
	...
	static CPrionBerserker** Create_InstancePool(ID3D12Device* pGraphicDevice,
										  ID3D12GraphicsCommandList* pCommandList, 

...
class CBaraka_M_Mystellium : public Engine::CGameObject
{
private:
	explicit CBaraka_M_Mystellium(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	explicit CBaraka_M_Mystellium(const CBaraka_M_Mystellium& rhs);
	virtual ~CBaraka_M_Mystellium() = default;

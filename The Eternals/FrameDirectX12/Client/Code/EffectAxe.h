...
class CEffectAxe : public Engine::CGameObject
{
private:
	explicit CEffectAxe(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CEffectAxe() = default; 
...
public:
	...
	static CEffectAxe** Create_InstancePool(ID3D12Device* pGraphicDevice,
		ID3D12GraphicsCommandList* pCommandList,

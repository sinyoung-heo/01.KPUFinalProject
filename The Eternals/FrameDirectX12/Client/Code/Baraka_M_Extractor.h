...
class CBaraka_M_Extractor : public Engine::CGameObject
{
private:
	explicit CBaraka_M_Extractor(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	explicit CBaraka_M_Extractor(const CBaraka_M_Extractor& rhs);
	virtual ~CBaraka_M_Extractor() = default;

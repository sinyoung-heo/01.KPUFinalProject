...
HRESULT CGameUIRoot::LateInit_GameObject()
{
...
_int CGameUIRoot::Update_GameObject(const _float& fTimeDelta)
{
...
void CGameUIRoot::Render_GameObject(const _float& fTimeDelta)
{
	if (nullptr != m_pTexDescriptorHeap)
	{
		Set_ConstantTable();
...
HRESULT CGameUIRoot::Add_Component()
{
...
HRESULT CGameUIRoot::Read_DataFromFilePath(wstring wstrDataFilePath)
{
...
void CGameUIRoot::Update_SpriteFrame(const _float& fTimeDelta)
{

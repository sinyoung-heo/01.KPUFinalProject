...
class CDrownedSailor : public Engine::CGameObject
{
private:
	explicit CDrownedSailor(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CDrownedSailor() = default;
...
public:
	...
	static CDrownedSailor** Create_InstancePool(ID3D12Device* pGraphicDevice,
												ID3D12GraphicsCommandList* pCommandList, 

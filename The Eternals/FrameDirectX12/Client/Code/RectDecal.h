...
class CRectDecal : public Engine::CGameObject
{
private:
	explicit CRectDecal(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
	virtual ~CRectDecal() = default; 
...
public:
	...
	static CRectDecal** Create_InstancePool(ID3D12Device* pGraphicDevice,
		ID3D12GraphicsCommandList* pCommandList,

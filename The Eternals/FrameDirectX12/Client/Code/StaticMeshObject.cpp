...
void CStaticMeshObject::Render_GameObject(ID3D12GraphicsCommandList * pCommandList, 
										  const _int& iContextIdx)
{
	m_pMeshCom->Render_StaticMesh(pCommandList, iContextIdx, m_pShaderCom);
}

void CStaticMeshObject::Render_ShadowDepth(ID3D12GraphicsCommandList * pCommandList, 
										   const _int& iContextIdx)
{

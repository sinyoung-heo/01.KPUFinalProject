...
private:
	...
	_float m_fAlpha = 1.f;
	_float m_fShaderDegree = 0.f;
	_float m_fLifeTime = 0.f;
	_float m_fCrossDeltatime = 0.f;
	_float m_fCrossDeltatime2 = 0.f;
	_float m_fCrossDeltatime3 = 0.f;
	_float m_fDeltatimeVelocity = 0.f;
	_float m_fDeltatimeVelocity2 = 1.f;

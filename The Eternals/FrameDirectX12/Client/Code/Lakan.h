...
class CLakan : public Engine::CGameObject
{
private:
	explicit CLakan(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList);
...
public:
	...
	static CLakan** Create_InstancePool(ID3D12Device* pGraphicDevice,
										  ID3D12GraphicsCommandList* pCommandList, 

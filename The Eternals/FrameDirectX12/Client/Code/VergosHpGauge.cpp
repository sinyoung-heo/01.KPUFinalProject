...
CVergosHpGauge::CVergosHpGauge(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: CGameUIChild(pGraphicDevice, pCommandList)
{
}

HRESULT CVergosHpGauge::Ready_GameObject(wstring wstrRootObjectTag, 
...
HRESULT CVergosHpGauge::LateInit_GameObject()
{
...
_int CVergosHpGauge::Update_GameObject(const _float& fTimeDelta)
{
...
_int CVergosHpGauge::LateUpdate_GameObject(const _float& fTimeDelta)
{
	if (g_bIsCinemaStart)
		return NO_EVENT;
...
void CVergosHpGauge::Render_GameObject(const _float& fTimeDelta)
{
...
void CVergosHpGauge::Set_ConstantTable()
{
...
Engine::CGameObject* CVergosHpGauge::Create(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList,
											...
											const _long& iUIDepth)
{
	CVergosHpGauge* pInstance = new CVergosHpGauge(pGraphicDevice, pCommandList);

...
class ENGINE_DLL CShaderDynamicMeshEffect final : public CShader
{
private:
	explicit CShaderDynamicMeshEffect(ID3D12Device * pGraphicDevice, ID3D12GraphicsCommandList * pCommandList);
	explicit CShaderDynamicMeshEffect(const CShaderDynamicMeshEffect& rhs);
	virtual ~CShaderDynamicMeshEffect() = default;

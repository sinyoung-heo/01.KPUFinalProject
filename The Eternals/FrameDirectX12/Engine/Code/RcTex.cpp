...
HRESULT CRcTex::Ready_Buffer()
{
	...
	{
		//		Pos											TexUV
		VTXTEX(_vec3(-0.5f, 0.5f, 0.0f), _vec2(0.0f, 0.0f)),	// 0
		VTXTEX(_vec3(0.5f, 0.5f, 0.0f), _vec2(1.0f, 0.0f)),	// 1
		VTXTEX(_vec3(0.5f, -0.5f, 0.0f), _vec2(1.0f, 1.0f)),	// 2
		VTXTEX(_vec3(-0.5f, -0.5f, 0.0f), _vec2(0.0f, 1.0f))	// 3
	};

...
CShaderDynamicMeshEffect::CShaderDynamicMeshEffect(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: CShader(pGraphicDevice, pCommandList)
{
}

CShaderDynamicMeshEffect::CShaderDynamicMeshEffect(const CShaderDynamicMeshEffect& rhs)
	: CShader(rhs)
{
...
HRESULT CShaderDynamicMeshEffect::SetUp_ShaderConstantBuffer(const _uint& uiNumSubsetMesh, const _uint& iAfterImgSize)
{
...
HRESULT CShaderDynamicMeshEffect::Ready_Shader()
{
...
void CShaderDynamicMeshEffect::Begin_Shader(ID3D12DescriptorHeap* pTexDescriptorHeap, const _uint& iSubMeshIdx)
{
...
HRESULT CShaderDynamicMeshEffect::Create_RootSignature()
{
	/*__________________________________________________________________________________________________________
	[ SRV를 담는 서술자 테이블을 생성 ]
	____________________________________________________________________________________________________________*/
...
HRESULT CShaderDynamicMeshEffect::Create_PipelineState()
{
	/*__________________________________________________________________________________________________________
	[ PipelineState 기본 설정 ]
	____________________________________________________________________________________________________________*/
...
vector<D3D12_INPUT_ELEMENT_DESC> CShaderDynamicMeshEffect::Create_InputLayout(string VS_EntryPoint,
	string PS_EntryPoint)
{
	vector<D3D12_INPUT_ELEMENT_DESC> vecInputLayout;

	m_pVS_ByteCode = Compile_Shader(L"../../Bin/Shader/ShaderDynamicMeshEffect.hlsl", nullptr, VS_EntryPoint.c_str(), "vs_5_1");
	m_pPS_ByteCode = Compile_Shader(L"../../Bin/Shader/ShaderDynamicMeshEffect.hlsl", nullptr, PS_EntryPoint.c_str(), "ps_5_1");
...
D3D12_BLEND_DESC CShaderDynamicMeshEffect::Create_BlendState(const _bool& bIsBlendEnable,
...
CComponent* CShaderDynamicMeshEffect::Clone()
{
	return new CShaderDynamicMeshEffect(*this);
}

CShader* CShaderDynamicMeshEffect::Create(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
{
	CShaderDynamicMeshEffect* pInstance = new CShaderDynamicMeshEffect(pGraphicDevice, pCommandList);
...
void CShaderDynamicMeshEffect::Free()
{
	CShader::Free();

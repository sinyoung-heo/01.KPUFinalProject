...
CToolUIChild::CToolUIChild(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: Engine::CGameObject(pGraphicDevice, pCommandList)
{
}

HRESULT CToolUIChild::Ready_GameObject(wstring wstrRootObjectTag,
...
HRESULT CToolUIChild::LateInit_GameObject()
{
...
_int CToolUIChild::Update_GameObject(const _float& fTimeDelta)
{
...
void CToolUIChild::Render_GameObject(const _float& fTimeDelta)
{
...
HRESULT CToolUIChild::Add_Component()
{
...
HRESULT CToolUIChild::Read_DataFromFilePath(wstring wstrDataFilePath)
{
...
void CToolUIChild::Set_ConstantTable()
{
	/*__________________________________________________________________________________________________________
...
void CToolUIChild::Update_SpriteFrame(const _float& fTimeDelta)
{
...
Engine::CGameObject* CToolUIChild::Create(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList, 
										  ...
										  const _long& iUIDepth)
{
	CToolUIChild* pInstance = new CToolUIChild(pGraphicDevice, pCommandList);

	if (FAILED(pInstance->Ready_GameObject(wstrRootObjectTag, wstrObjectTag,
										   wstrDataFilePath,
										   vPos,
										   vScale,
										   bIsSpriteAnimation,

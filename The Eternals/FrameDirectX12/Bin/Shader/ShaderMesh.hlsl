...
VS_OUT VS_TERRAIN_MAIN(VS_IN vs_input)
{
 ...
 //   vVertical.xyz = vs_input.Pos.xyz + (sin(g_fOffset2 * 1.f + vs_input.Pos.z * 1.f)) * 10.205f * (1 - vs_input.TexUV.y);
	////가로축의 웨이브 펙터 Wave, Lava
 //   vHorizontal.xyz = vs_input.Pos.xyz + (sin(g_fOffset2 * 1.f + vs_input.Pos.x * 1.f)) * 10.205f * (1 - vs_input.TexUV.y);
